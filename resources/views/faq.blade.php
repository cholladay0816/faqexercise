    ...
    @foreach($faq as $question)
        <div class="card">
            <div class="card-header row" id="heading{{$question->id}}">
                ...
                @can('manage-faq')
                <form method="POST" action="{{url('/faq/'.$question->id)}}">
                    <div class="col">
                        <a href="{{url('/faq/'.$question->id)}}" class="btn btn-primary">Edit</a>
                            @csrf
                            @method('DELETE')
                            <input type="submit" href="{{url('/faq/'.$question->id)}}" class="btn btn-danger" value="Delete"/>
                    </div>
                </form>
                @endcan
            </div>
